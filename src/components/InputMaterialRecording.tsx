                  ...
                  {formStep === 1 && (
                    <motion.div key="step1" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="space-y-6">
                      ...
                      {form.operation && form.recipe ? (
                        ...
                        <div className="py-12 bg-slate-50 border border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-slate-400 space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        {form.operation ? (
                          ...
                          <button onClick={() => setFormStep(3)} className="w-full p-6 bg-white border border-slate-100 rounded-2xl shadow-sm flex items-center justify-between group active:scale-[0.98] transition-all">
                            <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        {form.recipe ? (
                          ...
                          <button onClick={() => setFormStep(4)} className="w-full p-6 bg-white border border-slate-100 rounded-2xl shadow-sm flex items-center justify-between group active:scale-[0.98] transition-all">
                            <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-3">
                        {mockPlanting.map((op: any) => (
                          <button key={op.id} onClick={() => { setForm(p => ({ ...p, operation: op })); setFormStep(1); }}
                            className="w-full p-5 bg-white border border-slate-100 rounded-2xl text-left hover:border-blue-200 active:scale-[0.98] transition-all shadow-sm">
